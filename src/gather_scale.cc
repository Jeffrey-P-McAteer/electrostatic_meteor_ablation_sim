...
void gather_scale(ArrayNd<OTYPE, n_dist1> &den, PTYPEAVec *data[], FTYPE *xmin, 
...
void gather_scale(ArrayNd<OTYPE, n_dist2> &den, PTYPEAVec* data[], 
		  FTYPE *xmin, FTYPE *xmax, int *nmesh, int *iwrap, 
...
void gather_scale(ArrayNd<OTYPE, n_dist3> &den, PTYPEAVec *data[], FTYPE *xmin, 
		  FTYPE *xmax, int *nmesh, int *iwrap, FTYPE scale, int np, PTYPEAVec xmissing)
{
...
void gather_scale(ArrayNd<OTYPE, n_dist4> &den, PTYPEAVec *data[], FTYPE *xmin, 
		  FTYPE *xmax, int *nmesh, int *iwrap, FTYPE scale, int np, PTYPEAVec xmissing)
{
...
void gather_scale(ArrayNd<OTYPE, n_dist6> &den, PTYPEAVec *data[], FTYPE *xmin, 
		  FTYPE *xmax, int *nmesh, int *iwrap, FTYPE scale, int np, PTYPEAVec xmissing)
{
