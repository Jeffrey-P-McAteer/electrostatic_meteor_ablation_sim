...
void gather_weight(ArrayNd<OTYPE, n_dist1> &den, particle_dist &pic, 
...
void gather_weight(ArrayNd<OTYPE, n_dist2> &den, particle_dist &pic, 
		   PTYPEAVec &weight,  FTYPE *xmin, FTYPE *xmax, 
		   int *nmesh, int *iwrap, FTYPE scale)
{
...
void gather_weight(ArrayNd<OTYPE, n_dist3> &den, particle_dist &pic, 
		   PTYPEAVec &weight,  FTYPE *xmin, FTYPE *xmax, 
		   int *nmesh, int *iwrap, FTYPE scale)
{
...
void gather_weight(ArrayNd<OTYPE, n_dist4> &den, particle_dist &pic, 
		   PTYPEAVec &weight,  FTYPE *xmin, FTYPE *xmax, 
		   int *nmesh, int *iwrap, FTYPE scale)
{
...
void gather_weight(ArrayNd<OTYPE, n_dist6> &den, particle_dist &pic, 
		   PTYPEAVec &weight,  FTYPE *xmin, FTYPE *xmax, 
		   int *nmesh, int *iwrap, FTYPE scale)
{
