/* Maxwell Molecule elastic scattering routine:
   
   This code collides a fraction of particles with randomly generated 
   neutral particles.  Unlike the elastic scattering routine, it does 
   not make the collision probability velocity dependent, making these 
   scatter as Maxwell molecules.
		     ...
		     FTYPE *vth_neutral, FTYPE m_neutral, int &iran, FTYPE &dW) 
{
  ...
  FTYPE nptry = 1.0*(dist.np-dist.nabsent)*coll_frac;
