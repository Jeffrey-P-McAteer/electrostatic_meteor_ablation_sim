...
/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
     Convert 2D FArrayND_ranged object into a Vector
     - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
...
void FArrayND_rangedToVec2D(FArrayND_ranged &phi, Vec &phiVec, int nx, int ny, int n_exclude=-10)
{
  if (mpi_rank==0) {
    cout << "\tThis version of EPPIC was not configured with PETSC\n"
	 << "\tTherefore, FArrayND_rangedToVec2D is not available.\n"
