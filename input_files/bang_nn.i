...
; particle boundary_type_xyz: 0=periodic, 1=inject, 2=open
       ...
       boundary_type_y = 0
       boundary_type_z = 1
; field_boundary type open=-1, periodic=0, dirichlet=1, neumann=2
...
; number of particles, density, mass, charge, thermal velocity and drift speed
	...
	part_pad0 = 6000000
	n0d0 = 2e3
; neutral Na mass: Everything is normalized to this
        md0 = 3.8E-26
	qd0 = 0
...
; if crosssec_m_model = 1, coll_cross_section should not matter, 1 is jones model 5.1067e-20 (20km/s)
        ...
        coll_create_a_id0 = 1
	coll_create_b_id0 = 2
; thermal velocity 1eV=187520 m/s or 108270 for 9.1e-30 kg
        coll_create_vthb = 108270
; Atmospheric Neutrals N2 (T=380K 4.7E-26 kg)
...
; Atmospheric Neutrals N2 (T=380K 4.7E-26 kg)
        ...
        vy0d_neutral1 = 0
        vz0d_neutral1 = 40000
  ; Thermal velocities (assume 380K, 3.8e-26kg)
	vxthd1 = 303.4
	vythd1 = 303.4
	vzthd1 = 303.4
	vx0d1 = 0
...
; Third distribution: post collision electrons (10x e- mass)
	dist = 2
; number of particles, density, mass, charge, thermal velocity and drift speed
	npd2 = 500000
	part_pad2 = 10
...
; Atmospheric Neutrals N2 (T=380K 4.7E-26 kg) but 50 x lighter(for e-), so m = 9.4e-28
        massd_neutral2 = 9.4e-28
        vthd_neutral2 = 272.8
        vx0d_neutral2 = 0
        vy0d_neutral2 = 0
        vz0d_neutral2 = 40000
; Thermal velocities (assume 380K, 9.1e-30kg)
	vxthd2 = 19600
	vythd2 = 19600
	vzthd2 = 19600
	vx0d2 = 0
