...
if (n_elements(nseg) eq 0) then nseg=32
...
;Create the final array for storage:
E2kxkpw = FltArr(nx2, nperp, nphi_extent,nseg-1)
...
; ignore negative frequencies
    ...
    E2kxkpw(*,*,*,iseg)=shift(E2kppw,nx2/2,0,nphi_extent/2)
