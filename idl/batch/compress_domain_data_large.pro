pro compress_domain_data_large, InFile, OutFile, compress=compress, $
                               _EXTRA = e
; 
; NAME:
...
;
; CALLING SEQUENCE:
;	compress_domain_data_large, InFile, OutFile, ndim,  compres=compress, $
;                       _EXTRA = e
;
; INPUTS:
...
for i=0, nt-1 do begin 
    ...
    array=read_domains(InFile,[nx2/nsubdomains,ny2,nz2], ndomains=nsubdomains, $
                       order=[2,1,0],/binary,skip=iskip,first=i*array_size, $
                       last=(i+1)*array_size)
